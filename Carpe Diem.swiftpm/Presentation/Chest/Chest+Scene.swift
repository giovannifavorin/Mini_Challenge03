    ...
    class Scene: GameScene {
        ...
        override func didMove(to view: SKView) {
            ...
            if let textDialog = textDialog {
                let (dialogBox, blindbuttonNode) = textUtil.animateDialogBox(inScene: self, textDialog: textDialog)
                self.dialogBox = dialogBox
                self.blindbuttonNode = blindbuttonNode
            }
        ...
        override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
            for touch in touches {
                ...
                guard let blindbuttonNode = blindbuttonNode, let dialogBox = dialogBox else { return }
                if blindbuttonNode.frame.contains(touch.location(in: self)) {
                    print("Botão pressionado")
                    dialogBox.removeFromParent()
                    blindbuttonNode.removeFromParent()
                }
